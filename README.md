...
Snapshot date: **2026-09-24**. Department labels show unique apps. Because one app can support several platforms, its outgoing platform counts may sum above that unique total.
